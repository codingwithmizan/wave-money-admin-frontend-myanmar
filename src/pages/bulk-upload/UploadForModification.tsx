...
const UploadForModification = () => {
  ...
  console.log("isParsingCompleted", isParsingCompleted);

  setHeaderTitle("bulk-upload-for-modification");
  return (
    <div className="mb-6">
      ...
      <Card title="Bulk Upload for Modification" className="page-body pb-32">
        <Row>
          <Col
            className=" w-full"
            xs={{ span: 24 }}
...
export default UploadForModification;
