...
interface PendingProfileEditProps {
  otc: any;
  title: string;
}

export const PendingProfileEdit: FC<PendingProfileEditProps> = ({
  otc,
  title,
}) => {
  ...
  useEffect(() => {
    if (otc?.id_type === "nrc") {
      ...
      reset({
        ...
        father_name_mm: otc?.father_name_mm,
        dob: otc?.dob ? moment(otc?.dob) : "",
        gender: otc?.gender ? otc?.gender : "",
        address: otc?.address ? otc?.address : "",
        employement_status: otc?.employement_status,
        msisdn: otc?.account?.msisdn ? otc?.account?.msisdn : "",
        account_status: otc?.account_status ? otc?.account_status : "",
        kyc_status: otc?.kyc_status,
        nrc_number: otc?.id_number,
    ...
    <Card title={title} className="page-body pl-6">
      ...
      <div className="form-group">
        <div className="w-36  ">
          <FieldLabel
            name="nrc_number"
            label={`${otc?.id_type === "nrc" ? "NRC" : "Passport"} Number`}
            required
          />
        </div>
        <div className="form-control">
      ...
      <div className="form-group">
        ...
        <div className="form-control ">
          <Input control={control} name="father_name" errors={errors} />
        </div>
      </div>
      <div className="form-group">
        <div className="w-36  ">
        ...
        <div className="form-control ">
          <Input control={control} name="father_name_mm" errors={errors} />
        </div>
      </div>
      <div className="form-group">
        <div className="w-36  ">
      ...
      <div className="form-group">
        <div className="w-36  ">
          <FieldLabel name="account_status" label="Profile Status" required />
        </div>
        <div className="form-control ">
          <Select
            control={control}
